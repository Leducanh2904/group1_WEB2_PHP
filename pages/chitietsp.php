				...
				<div class="col-lg-9 col-col-md-9 col-sm-12 col-xs-12">
					<div class="row">
							...
							<div class="product-image-block relative">
								...
								<div class="swiper-container gallery-thumbs swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events swiper-container-free-mode swiper-container-thumbs">
									<div class="swiper-wrapper">
											...
											<div class="p-100">
												<img height="400" width="400" src="../images/giay-cau-long-kawasaki-065-trang-chinh-hang-1090.png" alt="Giày cầu lông Kawasaki 065 chính hãng" data-image="giay-cau-long-kawasaki-065-trang-chinh-hang-1090.png" class="swiper-lazy swiper-lazy-loaded">
											</div>	
										</div>
													<div class="swiper-slide swiper-slide-visible swiper-slide-next" data-hash="1" style="width: 60px; margin-right: 5px;">
											<div class="p-100">
												<img height="400" width="400" src="../images/anhmotagiaycaulongkawasaki065.png" alt="Giày cầu lông Kawasaki 065 chính hãng" data-image="giay-cau-long-kawasaki-065-trang-chinh-hang-1090.png" class="swiper-lazy swiper-lazy-loaded">
											</div>	
										</div>
						...
						<div class="details-pro col-12 col-md-6 col-lg-7">
							<h1 class="title-product">Giày cầu lông Kawasaki 065 chính hãng</h1>
							<div class="product-top clearfix">
								<div class="sku-product clearfix">
																	
																		<span class="variant-sku"  content="TQDA017091">Mã: <span class="a-sku">TQDA017091</span></span>
								</div>
							</div>
...
<div class="product-tab e-tabs not-dqtab">
	...
	<div class="col-md-12">
		<p style="text-align:center"><span style="font-size:16px"><span style="font-family:arial,helvetica,sans-serif"><strong>Giày Cầu Lông Kawasaki 065 - Vững chãi trên từng bước chạy</strong></span></span></p>

<h2><span style="font-size:16px"><span style="font-family:arial,helvetica,sans-serif"><strong>1. Giới thiệu giày cầu lông&nbsp;Kawasaki&nbsp;065</strong></span></span></h2>

<p><span style="font-size:16px"><span style="font-family:arial,helvetica,sans-serif">- Mặc dù đã được cho ra mắt vào năm 2017 nhưng đến nay vẫn không ngừng hết hot đó chính là&nbsp;giày cầu lông kawasaki 065,&nbsp;đây&nbsp;là một trong những&nbsp;mẫu giày mới nhất trong năm 2017 của hãng Kawasaki. Giày được thiết kế rất sang trọng và chuyên nghiệp.</span></span></p>
...
<h2><span style="font-size:16px"><span style="font-family:arial,helvetica,sans-serif"><strong>2. Tổng quan giày cầu lông hiện đại&nbsp;Kawasaki 065</strong></span></span></h2>

<p><span style="font-size:16px"><span style="font-family:arial,helvetica,sans-serif">- Màu sắc&nbsp;giày cầu lông hiện đại Kawasaki 065:&nbsp;Trắng/ Xanh dương</span></span></p>
...
<h3><span style="font-size:16px"><span style="font-family:arial,helvetica,sans-serif"><strong>* Bảng size&nbsp;bao gồm giày cầu lông hiện đại&nbsp;<a>Kawasaki 065</a></strong></span></span></h3>

<p><span style="font-size:16px"><span style="font-family:arial,helvetica,sans-serif"><img alt="Size giày cầu lông Kawasaki 065" src="bangsizegiay.webp"></span></span></p>

<h2><span style="font-size:16px"><span style="font-family:arial,helvetica,sans-serif"><strong>3. Ưu điểm của giày cầu lông bền bỉ&nbsp;Kawasaki 065</strong></span></span></h2>

<p><span style="font-size:16px"><span style="font-family:arial,helvetica,sans-serif">-&nbsp;Giày cầu lông Kawasaki 065&nbsp;là mẫu giày phân khúc tầm trung&nbsp;của <a >KAWASAKI</a> với mức giá vừa phải nhưng vẫn mang trong mình công nghệ tốt nhất để bảo vệ cho đôi chân bạn. Các nét điểm chi tiết có thiết kế mạnh mẽ hơn, tạo nên một form giầy cực chuẩn, điểm nhấn cho sự cá tính, năng động cho các bạn.</span></span></p>
...
<p><span style="font-size:16px"><span style="font-family:arial,helvetica,sans-serif">-&nbsp;Giày cầu lông bền bỉ&nbsp;Kawasaki 065&nbsp;sẽ là sự lựa chọn hoàn hảo cho những người chơi cần cải thiện tốc độ, giúp bạn chạy nhảy linh hoạt hơn mà vẫn tạo sự thoải mái nhất.<br>
<br>
		</div>
	<div class="tab-float">
