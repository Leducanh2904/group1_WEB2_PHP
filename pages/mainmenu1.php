...
<ul class = "main-menu">
    ...
    <li class="dropdown"><div class = "main-menu"><a class="dropbtn">Hướng dẫn</a></div>
        ...
        <div class="dropdown-content">
            <ul >
                ...
                <li><a href="../pages/huongdanthanhtoan.php" target="_blank">Hướng dẫn thanh toán</a>
                    <div class="sub-dropdown-content">
                    </div>
                </li>
            </ul>
            <li class="nodrop"><a href="../pages/gioithieu.php">Giới thiệu</a></li>
            <li class="nodrop"><a href="../pages/lienhe.php">Liên hệ</a></li>
</ul>
    <div class="flip-box">
    ...
    <div><button onclick="topFunction()" id="myBtn" title="Go to top"><img src="../images/ontop.png" alt=""></button>
        <script>
