            ...
            <div class="logodangnhap1">
                <a href= <?php
                        if(!isset($_COOKIE["user"])) {
                            echo "../pages/dangnhap.php";
                        } else {
                        
                            echo "../pages/taikhoan.php";
                        }
                    ?> >
...
<ul class = "main-menu" style="margin-top: 14px; margin-left: 8px; width: 100%; height: 32px;">
    ...
    <li class="nodrop" style="margin-top: -0.5px;"><a>Tin tức</a></li>
    <li class="dropdown" style="margin-top: -0.5px;"><div class = "main-menu"><a class="dropbtn">Hướng dẫn</a></div>
        ...
        <div class="dropdown-content">
            ...
            <li class="nodrop" style="margin-top: -0.5px;"><a>Giới thiệu</a></li>
            <li class="nodrop" style="margin-top: -0.5px;"><a>Liên hệ</a></li>
</ul>